...
<aside
  class="flex w-full h-full flex-col gap-4 select-none shrink-0"
>
  <!-- WORKSPACES Box -->
  ...
  <div class="relative flex flex-col bg-box-bg border border-border flex-1 min-h-0">
    <span
      ...
      >Categories</span
    >
    <div class="flex-1 overflow-y-auto p-4 min-h-0 [&::-webkit-scrollbar]:w-[4px] [&::-webkit-scrollbar-thumb]:bg-border hover:[&::-webkit-scrollbar-thumb]:bg-primary">
      <div class="space-y-1 text-xs">
