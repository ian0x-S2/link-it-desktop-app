...
<div class="flex flex-col gap-6 font-mono text-xs">
  ...
  <div class="flex items-center justify-between border-b border-border pb-3">
    <div class="flex flex-col">
      ...
      >
      <span class="text-[9px] text-dim-foreground mt-0.5"
        >Manage and inspect workspaces statistics</span
      >
    </div>
    <button
      onclick={onCloseSettings}
      class="border border-border bg-transparent text-muted-foreground hover:border-primary hover:text-primary transition-all duration-100 ease-linear cursor-pointer px-2 py-0.5 text-[10px] uppercase font-bold"
    >
      [ Esc ] Close
    </button>
  </div>
  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
    <div class="border border-border p-3 bg-box-bg/25 flex flex-col gap-1">
      <span class="text-[9px] uppercase font-bold text-dim-foreground">Workspaces</span>
      <span class="text-lg font-bold text-foreground">{totalWorkspaces}</span>
    </div>
    <div class="border border-border p-3 bg-box-bg/25 flex flex-col gap-1">
      <span class="text-[9px] uppercase font-bold text-dim-foreground">Active Links</span>
      <span class="text-lg font-bold text-primary">{totalActive}</span>
    </div>
    <div class="border border-border p-3 bg-box-bg/25 flex flex-col gap-1">
      <span class="text-[9px] uppercase font-bold text-dim-foreground">Favorites</span>
      <span class="text-lg font-bold text-foreground">{totalFavorite}</span>
    </div>
    <div class="border border-border p-3 bg-box-bg/25 flex flex-col gap-1">
      <span class="text-[9px] uppercase font-bold text-dim-foreground">Trashed</span>
  ...
  <div class="flex flex-col gap-2">
    <span class="text-[10px] font-bold text-foreground uppercase tracking-wider"
    ...
    <div class="border border-border bg-box-bg/10 overflow-x-auto">
      <table class="w-full text-left border-collapse min-w-125">
        <thead>
          <tr
            class="border-b border-border bg-box-bg/30 text-[9px] text-dim-foreground uppercase tracking-wider font-bold"
          >
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-border pt-4">
    <div class="flex flex-col gap-2">
      ...
      >
      <div
        class="border border-border bg-box-bg/10 p-3 space-y-1.5 text-[10px] text-muted-foreground"
      >
    ...
    <div class="flex flex-col gap-2">
      ...
      >
      <div
        class="border border-border bg-box-bg/10 p-3 space-y-2 text-[10px] text-muted-foreground"
      >
        <div class="flex flex-col">
