...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
  ...
  <!-- Ghost Card to add a new media (always at the end) -->
  ...
  >
    ...
    <span
      ...
      >Add New Media</span
    >
    <span class="text-tui-2xs text-dim-foreground mt-1 select-none">// click to catalog a movie, series or video</span
    >
  </div>
</div>
