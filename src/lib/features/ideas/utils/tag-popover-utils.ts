...
/**
 * Collects all unique tags from a list of ideas, sorted alphabetically.
 */
...
/**
 * Returns tag suggestions filtered by query and excluding tags already on the idea.
 *
 * @param allTags   - Full sorted list of unique tags (from getAllUniqueTags)
 * @param existingTags - Tags already assigned to the current idea
